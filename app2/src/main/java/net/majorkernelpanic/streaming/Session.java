...
public class Session {
	...
	/** Returns the underlying {@link AudioStream} used by the {@link net.majorkernelpanic.streaming.Session}. */
	public AudioStream getAudioTrack() {
		return mAudioStream;
	}

	/** Returns the underlying {@link VideoStream} used by the {@link net.majorkernelpanic.streaming.Session}. */
	 ...
	 * {@link net.majorkernelpanic.streaming.Session#getVideoTrack()} and {@link VideoStream#getFlashState()}.
	 **/
